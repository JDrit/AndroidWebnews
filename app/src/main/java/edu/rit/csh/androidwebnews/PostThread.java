...
public class PostThread {
    ...
    private final String personal_class;
    private final int number;
    private int depth;
    private boolean starred;
    private final ArrayList<PostThread> children;
    ...
    public boolean Equals(Object object) {
        return object instanceof PostThread && ((PostThread) object).newsgroup.equals(newsgroup) &&
                ((PostThread) object).number == number;
